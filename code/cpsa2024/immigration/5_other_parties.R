...
graph_data <- potgrowth::dynamic_potgrowth_data(
  data = survey_data,
  parties = c("PCQ", "PLQ", "CAQ"),
  issues = "iss_immig_immLess",
) %>% 
...
ggsave("_SharedFolder_memoire-pot-growth/graphs/cpsa2024/dynamic_potgrowth/immigration/5_other_parties.png",
