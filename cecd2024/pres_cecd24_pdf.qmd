---
title: "<span style='font-size: 49pt;'>Opérationnaliser le <span style='color: #FFDCA2; font-size:60pt;'>potentiel de croissance</span> des partis politiques dans un système multipartite</span>"
...
- Les partis ont des contraintes
  ...
  - Limitent et cadrent les actions possibles que le parti peut prendre &rarr; [***marge de manoeuvre***]{style="color: #FFDCA2;"}
...
# Mise en contexte
Répertoire d'actions à l'intérieur de cette [***marge de manoeuvre***]{style="color: #FFDCA2;"}:<br>
...
# Définition
[***Potentiel de croissance***]{style="color: #FFDCA2;"}: performance électorale si les stratégies disponibles dans sa marge de manœuvre sont optimisées
...
- Ancrage dans les théories classiques du choix de vote
  - [Columbia]{style="font-size: 40pt; color: #FFDCA2;"} variables socio-démographiques (Lazarsfeld et al. 1948, Berenson et al. 1954)
  - [Michigan]{style="font-size: 40pt; color: #FFDCA2;"} + identification partisane, modèle plus flexible (Campbell et al. 1960, Lewis-Beck et al. 2008)
...
## Entonnoir de causalité, adaptation contexte québécois
...
1. Potentiel de croissance [statique]{style="font-size: 50pt; color: #B3E5FC;"}: en conservant ses positions actuelles sur un enjeu.<br>[Atteint via stratégies de communication politique.]{style="font-size: 20pt;"}
...
::: {.nonincremental}
1. Potentiel de croissance [statique]{style="font-size: 50pt; color: #B3E5FC;"}: la récente montée du PQ
...
- Fait la distinction entre les électeurs inatteignables et atteignables &rarr; [***potentiel de croissance***]{style="font-size: 40pt; color: #FFDCA2;"}
<!--- - Fait la distinction entre un électeur solide et un électeur fragile &rarr; [***solidité du vote***]{style="font-size: 40pt; color: #FFDCA2;"} --->
:::

# Application du potentiel de croissance [statique]{style="color: #B3E5FC;"}
[La récente montée du PQ]{style="font-size: 40pt;"}

## Potentiel de croissance [statique]{style="color: #B3E5FC;"}: la montée du PQ
...
En agrégeant l'IRC à différents niveaux, on peut situer où se trouve le potentiel de croissance [statique]{style="color: #B3E5FC;"} des partis politiques
...
## Prochaines étapes
Objectif final: modèle systématique qui identifie segments électoraux à cibler ([statique]{style="color: #B3E5FC;"}) et positionnement optimal ([dynamique]{style="color: #FF9800;"})
